...
\req
    ...
    {\parent{Sys-HL-REQ-1}, \parent{Sys-HL-REQ-2}, \parent{Sys-HL-REQ-4}, \parent{Sys-HL-REQ-6}, \parent{Sys-HL-REQ-13}}
    {FCPS}
\req
    {6}{Launch Detection}
    {
...
\req
    ...
    {\parent{Sys-HL-REQ-5}, \parent{Sys-HL-REQ-7}}
    {FCS}
\req

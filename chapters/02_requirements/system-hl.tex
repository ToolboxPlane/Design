...
\dd{1}{Partitioning}
{
			...
			\begin{figure}[H] 
				\centering 
				\includegraphics[width=.7\textwidth]{chapters/02_requirements/system.eps} 
...
\dd{3}{Frequency of FCPS control loop}
...
\dd{4}{Frequency of FCS control loop}
